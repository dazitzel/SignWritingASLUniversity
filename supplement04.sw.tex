...
When selecting a symbol for index finger extented, you could use a symbol like \tikz{\draw(0,0)circle(5pt);\filldraw(0,0)circle(1pt);} and just learn that it means index finger extended.
