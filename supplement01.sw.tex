...
\bul I am able to explain how the glyhs of SignWriting are organized.\\
...
For instance, if the practice senctence said something like: ``1. \textquestiondown C\'omo se llama?'', you wouldn't practice saying ``One dot inverted question mark c\'omo se llama question mark''.
...
Then you will be expected to apply that knowledge in all additional practice sheets, and we will try to warn you about new punctuation before we use it.
...
B530x508S38b04470x493&)&This normally would be paired with an opening paretheses as well.
The fact that we have a closing parentheses without an opening paretheses points out that this separates the counter from the actual sentence to practice.
...
B536x507S38900464x493&?&Draw two lines, connect them by making an wide ``X'' between the lines, then draw another line in front of them.\\
\end{tabular}
...
Number eleven introduces a new puctuation mark of \begin{tabular}{c}B536x504S38800464x496\end{tabular} or period.
